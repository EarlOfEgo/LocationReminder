...
public class SpecifyDaysAndTime extends Activity {
	...
	private void checkChoosenTime(){
		if((fromTime[MONDAY][HOUR]*100 + fromTime[MONDAY][MINUTE]) >= (toTime[MONDAY][HOUR]*100 + toTime[MONDAY][MINUTE])){
		...
		if((fromTime[TUESDAY][HOUR]*100 + fromTime[TUESDAY][MINUTE]) >= (toTime[TUESDAY][HOUR]*100 + toTime[TUESDAY][MINUTE])){
		...
		if((fromTime[WEDNESDAY][HOUR]*100 + fromTime[WEDNESDAY][MINUTE]) >= (toTime[WEDNESDAY][HOUR]*100 + toTime[WEDNESDAY][MINUTE])){
		...
		if((fromTime[THURSDAY][HOUR]*100 + fromTime[THURSDAY][MINUTE]) >= (toTime[THURSDAY][HOUR]*100 + toTime[THURSDAY][MINUTE])){
		...
		if((fromTime[FRIDAY][HOUR]*100 + fromTime[FRIDAY][MINUTE]) >= (toTime[FRIDAY][HOUR]*100 + toTime[FRIDAY][MINUTE])){
		...
		if((fromTime[SATURDAY][HOUR]*100 + fromTime[SATURDAY][MINUTE]) >= (toTime[SATURDAY][HOUR]*100 + toTime[SATURDAY][MINUTE])){
		...
		if((fromTime[SUNDAY][HOUR]*100 + fromTime[SUNDAY][MINUTE]) >= (toTime[SUNDAY][HOUR]*100 + toTime[SUNDAY][MINUTE])){
	...
	private void updateDisplays() {
		mondayFrom.setText(
	        new StringBuilder()
	                .append(pad(fromTime[MONDAY][HOUR])).append(":")
	                .append(pad(fromTime[MONDAY][MINUTE])));
		tuesdayFrom.setText(
		        new StringBuilder()
                .append(pad(fromTime[TUESDAY][HOUR])).append(":")
                .append(pad(fromTime[TUESDAY][MINUTE])));
		wednesdayFrom.setText(
		        new StringBuilder()
                .append(pad(fromTime[WEDNESDAY][HOUR])).append(":")
                .append(pad(fromTime[WEDNESDAY][MINUTE])));
		thursdayFrom.setText(
		        new StringBuilder()
                .append(pad(fromTime[THURSDAY][HOUR])).append(":")
                .append(pad(fromTime[THURSDAY][MINUTE])));
		fridayFrom.setText(
		        new StringBuilder()
                .append(pad(fromTime[FRIDAY][HOUR])).append(":")
                .append(pad(fromTime[FRIDAY][MINUTE])));
		saturdayFrom.setText(
		        new StringBuilder()
                .append(pad(fromTime[SATURDAY][HOUR])).append(":")
                .append(pad(fromTime[SATURDAY][MINUTE])));
		sundayFrom.setText(
		        new StringBuilder()
                .append(pad(fromTime[SUNDAY][HOUR])).append(":")
                .append(pad(fromTime[SUNDAY][MINUTE])));
		
		
		mondayTo.setText(
		        new StringBuilder()
	                .append(pad(toTime[MONDAY][HOUR])).append(":")
	                .append(pad(toTime[MONDAY][MINUTE])));
		tuesdayTo.setText(
		        new StringBuilder()
                .append(pad(toTime[TUESDAY][HOUR])).append(":")
                .append(pad(toTime[TUESDAY][MINUTE])));
		wednesdayTo.setText(
		        new StringBuilder()
                .append(pad(toTime[WEDNESDAY][HOUR])).append(":")
                .append(pad(toTime[WEDNESDAY][MINUTE])));
		thursdayTo.setText(
		        new StringBuilder()
                .append(pad(toTime[THURSDAY][HOUR])).append(":")
                .append(pad(toTime[THURSDAY][MINUTE])));
		fridayTo.setText(
		        new StringBuilder()
                .append(pad(toTime[FRIDAY][HOUR])).append(":")
                .append(pad(toTime[FRIDAY][MINUTE])));
		saturdayTo.setText(
		        new StringBuilder()
                .append(pad(toTime[SATURDAY][HOUR])).append(":")
                .append(pad(toTime[SATURDAY][MINUTE])));
		sundayTo.setText(
		        new StringBuilder()
                .append(pad(toTime[SUNDAY][HOUR])).append(":")
                .append(pad(toTime[SUNDAY][MINUTE])));
		checkChoosenTime();
	}
	    ...
	    switch (id) {
		    case MONDAY_FROM:
		        return new TimePickerDialog(this,
		            mondayFromTimeSetListener, fromTime[MONDAY][HOUR], fromTime[MONDAY][MINUTE], false);
			case TUESDAY_FROM:
				return new TimePickerDialog(this,
	                tuesdayFromTimeSetListener, fromTime[TUESDAY][HOUR], fromTime[TUESDAY][MINUTE], false);
			case WEDNESDAY_FROM:
				return new TimePickerDialog(this,
	                wednesdayFromTimeSetListener, fromTime[WEDNESDAY][HOUR], fromTime[WEDNESDAY][MINUTE], false);
			case THURSDAY_FROM:
				return new TimePickerDialog(this,
	                thursdayFromTimeSetListener, fromTime[THURSDAY][HOUR], fromTime[THURSDAY][MINUTE], false);
			case FRIDAY_FROM:
				return new TimePickerDialog(this,
	                fridayFromTimeSetListener, fromTime[FRIDAY][HOUR], fromTime[FRIDAY][MINUTE], false);
			case SATURDAY_FROM:
				return new TimePickerDialog(this,
	                saturdayFromTimeSetListener, fromTime[SATURDAY][HOUR], fromTime[SATURDAY][MINUTE], false);
			case SUNDAY_FROM:
				return new TimePickerDialog(this,
	                sundayFromTimeSetListener, fromTime[SUNDAY][HOUR], fromTime[SUNDAY][MINUTE], false);
			case MONDAY_TO:
		        return new TimePickerDialog(this,
		                mondayToTimeSetListener, toTime[MONDAY][HOUR], toTime[MONDAY][MINUTE], false);
			case TUESDAY_TO:
				return new TimePickerDialog(this,
	                tuesdayToTimeSetListener, toTime[TUESDAY][HOUR], toTime[TUESDAY][MINUTE], false);
			case WEDNESDAY_TO:
				return new TimePickerDialog(this,
	                wednesdayToTimeSetListener, toTime[WEDNESDAY][HOUR], toTime[WEDNESDAY][MINUTE], false);
			case THURSDAY_TO:
				return new TimePickerDialog(this,
	                thursdayToTimeSetListener, toTime[THURSDAY][HOUR], toTime[THURSDAY][MINUTE], false);
			case FRIDAY_TO:
				return new TimePickerDialog(this,
	                fridayToTimeSetListener, toTime[FRIDAY][HOUR], toTime[FRIDAY][MINUTE], false);
			case SATURDAY_TO:
				return new TimePickerDialog(this,
	                saturdayToTimeSetListener, toTime[SATURDAY][HOUR], toTime[SATURDAY][MINUTE], false);
			case SUNDAY_TO:
				return new TimePickerDialog(this,
	                sundayToTimeSetListener, toTime[SUNDAY][HOUR], toTime[SUNDAY][MINUTE], false);
	    }
		return null;
	...
	private TimePickerDialog.OnTimeSetListener mondayFromTimeSetListener =
	...
	private TimePickerDialog.OnTimeSetListener tuesdayFromTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener wednesdayFromTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener thursdayFromTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener fridayFromTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener saturdayFromTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener sundayFromTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener mondayToTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener tuesdayToTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener wednesdayToTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener thursdayToTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener fridayToTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener saturdayToTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
	...
	private TimePickerDialog.OnTimeSetListener sundayToTimeSetListener =
		    new TimePickerDialog.OnTimeSetListener() {
		        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
